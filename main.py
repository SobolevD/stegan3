...
from utils.distortion import cut, scale, smooth, jpeg, cut_bulk, scale_bulk, smooth_bulk, jpeg_bulk
...
if __name__ == '__main__':
    ...
    jpeg_images = jpeg_bulk(image, 30, 100, 10)
